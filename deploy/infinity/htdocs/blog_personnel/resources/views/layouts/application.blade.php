...
<body class="min-h-screen bg-gradient-to-b from-slate-50 to-slate-100/80">
    <header class="sticky top-0 z-30 border-b border-slate-200/80 bg-white/90 backdrop-blur">
        <div class="mx-auto flex max-w-6xl items-center justify-between px-4 py-4">
            <a href="{{ route('accueil') }}" class="flex items-center gap-2">
                <span class="flex h-9 w-9 items-center justify-center rounded-xl bg-brand-600 text-sm font-bold text-white">B</span>
            ...
            <nav class="flex flex-wrap items-center justify-end gap-1 sm:gap-3 text-sm">
                <a href="{{ route('recherche') }}" class="inline-flex rounded-lg p-2 text-slate-600 hover:bg-slate-100 hover:text-brand-600" title="Rechercher" aria-label="Rechercher">
